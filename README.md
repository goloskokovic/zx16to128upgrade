...
Upgrade ZX Spectrum 48k with 128kB of RAM and play all the games you couldn't play before. The sound will stay as before, but you can build make an [AY interface](https://github.com/konkotgit/KAY-Kempston-AY) to sound like ZX Spectrum 128k.
